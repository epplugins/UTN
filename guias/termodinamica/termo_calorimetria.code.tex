...
\begin{center}
  \begin{tikzpicture}[scale=0.8]
      ...
      \addplot [color=red, thick] [id=s,samples= 180, domain=0:1]  {-5+15*x};
      \addplot [color=red, thick] [id=s,samples= 180, domain=1:2.5]  {10};
      \addplot [color=red, thick] [id=s,samples= 180, domain=2.5:4]  {10+20*(x-2.5)};
      \end{axis}
    \end{tikzpicture}
